# -*- coding:utf8 -*-
# @TIME     : 2020/12/30 10:44
# @Author   : SuHao
# @File     : siamese_CNN_test.py
...
parser.add_argument("--experiment", default=r"../experiments/siamese_CNN_test", help="path to save experiments results")
...
parser.add_argument("--size", type=int, default=100, help="size of image after scaled")
...
parser.add_argument("--siamese_pth", default=r"../experiments/siamese_CNN_train/siamese.pth", help="pretrained model")
...
def test():
    ## dataset
    ## AddSaltPepperNoise(0.1),  AddGaussianNoise(70)
