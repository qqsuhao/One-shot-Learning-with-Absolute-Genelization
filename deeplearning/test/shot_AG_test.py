...
parser.add_argument("--experiment", default=r"../experiments/shot_AG_test", help="path to save experiments results")
...
parser.add_argument("--siamese_pth", default=r"../experiments/shot_AG_train/siamese.pth", help="pretrained model")
